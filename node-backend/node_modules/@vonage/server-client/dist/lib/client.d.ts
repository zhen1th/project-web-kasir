...
import { PartialTransformFunction } from './transformers';
...
export declare class Client {
    ...
    static transformers: {
        ...
        omit: (keys: Array<string>, obj: import("./transformers").ObjectToTransform) => import("./transformers").TransformedObject;
    };
    /**
