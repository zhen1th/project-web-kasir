...
<body>
    ...
    <div class="container">
        ...
        <h3>Input Laporan Toko Anda</h3>

        <form action="" method="POST">
            <input type="text" placeholder="Masukkan Nominal" name="Nominal_Pemasukkan" required>
            <button type="submit" name="Tambahkan_Nominal">Simpan</button>
        </form>
    </div>

    <div class="validate" id="successValidate">
    ...
    <script>
        function showModal() {
            document.getElementById("successValidate").style.display = "flex";
        }

        function closeModal() {
            document.getElementById("successValidate").style.display = "none";
...
if (isset($_POST['Tambahkan_Nominal'])) {
    $nominalpemasukkan = $_POST['Nominal_Pemasukkan'];

    mysqli_query($koneksidata, "INSERT INTO laporan_analitik (Nominal_Pemasukkan) VALUES ('$nominalpemasukkan')")
